    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.PositiveSmallIntegerField(choices=[(0, 'Measure not selected'), (1, 'Weight'), (2, 'Quantity'), (3, 'Length')], default=0, verbose_name='Measure Category')),
            ],
        ),
        migrations.CreateModel(
            name='ProductImage',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('measure', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='products.ProductMeasure')),
